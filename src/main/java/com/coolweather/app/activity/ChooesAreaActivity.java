...
/** 用于遍历省市县数据的活动
 * Created by M1308_000 on 2016/9/1.
 */
public class ChooesAreaActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> adapterView, View view, int index, long agr3) {
        ...
        HttpUtil.sendHttpRequest(address, new HttpCallbackListener() {
            ...
            public void onError(Exception e) {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        closeProgressDialog();
                        Toast.makeText(ChooesAreaActivity.this, "加载失败", 1).show();
                    }
                });
            }
        });
